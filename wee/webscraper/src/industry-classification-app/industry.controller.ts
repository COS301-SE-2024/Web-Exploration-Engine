...
export class IndustryController {
  ...
  @ApiQuery({
    name: 'url',
    required: true,
    description: 'The URL to scrape metadata from',
  })
  ...
  @ApiResponse({
    status: 500,
    description: 'Internal Server Error. Cannot scrape this URL',
  })
  @Get()
  ...
  @ApiQuery({
    name: 'url',
    required: true,
    description: 'The URL to check for scraping permission',
  })
