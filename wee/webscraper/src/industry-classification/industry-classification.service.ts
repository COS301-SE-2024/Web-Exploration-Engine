...
export class IndustryClassificationService {
  ...
  async classifyIndustry(
    ...
    try {
      ...
      logger.info(serviceName, 'zeroShotMetaDataClassify', error.message);
    ...
    try {
      ...
      logger.info(serviceName, 'zeroShotDomainClassify', error.message);
