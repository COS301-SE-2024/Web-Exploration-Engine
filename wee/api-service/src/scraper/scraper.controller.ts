...
export class ScraperController {
  ...
  async scrape(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing scraping task for url: ', url);
      const message = {
        type: 'scrape',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrape method:',
          error.message
        );
        throw error;
      } else {
        logger.error(serviceName, 'Unhandled error in scrape method:', error);
  ...
  async readRobotsFile(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing read-robots task for url: ', url);
      const message = {
        type: 'read-robots',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in readRobotsFile method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in readRobotsFile method:',
          error.message
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeMetadata(@Query('url') url: string) {
    try {
      ...
      logger.info(
        serviceName,
        'Publishing scrape-metadata task for url: ',
        url
      );
      const message = {
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeMetadata method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeMetadata method:',
          error.message
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeStatus(@Query('url') url: string) {
    try {
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeStatus method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeStatus method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async classifyIndustry(@Query('url') url: string) {
    try {
      ...
      logger.info(
        serviceName,
        'Publishing classify-industry task for url: ',
        url
      );
      const message = {
      ...
      if (error instanceof HttpException) {
        ...
        logger.error(
          serviceName,
          'Unhandled error in classifyIndustry method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeImages(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing scrape-images task for url: ', url);
      const message = {
        type: 'scrape-images',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeImages method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeImages method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeLogo(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing scrape-logo task for url: ', url);
      const message = {
        type: 'scrape-logo',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeLogo method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeLogo method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async getScreenshot(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing screenshot task for url: ', url);
      const message = {
        type: 'screenshot',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in getScreenshot method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in getScreenshot method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeContactInfo(@Query('url') url: string) {
    try {
      ...
      logger.info(
        serviceName,
        'Publishing scrape-contact-info task for url: ',
        url
      );
      const message = {
      ...
      if (error instanceof HttpException) {
        ...
        logger.error(
          serviceName,
          'Unhandled error in scrapeContactInfo method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeAddresses(@Query('url') url: string) {
    try {
      ...
      logger.info(
        serviceName,
        'Publishing scrape-addresses task for url: ',
        url
      );
      const message = {
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeAddresses method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeAddresses method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async seoAnalysis(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing seo-analysis task for url: ', url);
      const message = {
        type: 'seo-analysis',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in seoAnalysis method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in seoAnalysis method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async keywordAnalysis(
    ...
    try {
      ...
      logger.info(
        serviceName,
        'Publishing keyword analysis task for url: ',
        url
      );
      const message = {
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in keywordAnalysis method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in keywordAnalysis method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeNews(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing scrape-news task for url: ', url);
      const message = {
        type: 'scrape-news',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeNews method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeNews method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async socialAnalytics(@Query('url') url: string) {
    try {
      ...
      if (error instanceof HttpException) {
        ...
        logger.error(
          serviceName,
          'Unhandled error in shareCount analytics method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async scrapeReviews(@Query('url') url: string) {
    try {
      ...
      logger.info(serviceName, 'Publishing scrape-reviews task for url: ', url);
      const message = {
        type: 'scrape-reviews',
        data: { url },
      };
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in scrapeReviews method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in scrapeReviews method:',
          error
        );
        throw new HttpException(
          'Internal server error',
  ...
  async getJobStatus(@Query('type') type: string, @Query('url') url: string) {
    logger.info(serviceName, url, type);
    try {
      const acceptedTypes = [
        'scrape',
        'read-robots',
      ...
      if (error instanceof HttpException) {
        logger.warn(
          serviceName,
          'Handled error in getJobStatus method:',
          error.message
        );
        throw error;
      } else {
        logger.error(
          serviceName,
          'Unhandled error in getJobStatus method:',
          error
        );
        throw new HttpException(
          'Internal server error',
